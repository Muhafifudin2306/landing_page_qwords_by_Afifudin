    ...
    <x-hero_section></x-hero_section>
     ...
     <x-domain></x-domain>
        ...
        <div class="row mb-4 mt-6">
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/4.png') }}" alt="Dashboard" style="width:95px;" />
            <h4 class="mt-3 lh-base">High Conversions</h4>
            <p class="fs-0">Convert more wesite visitors in signups ans purchases.</p>
          </div>
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/5.png') }}" alt="Comment" style="width:95px;" />
            <h4 class="mt-3 lh-base">Save on Acquisition</h4>
            <p class="fs-0">Your advertising spend will go further than ever before.</p>
          </div>
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/6.png') }}" alt="Tailored" style="width:95px;" />
            <h4 class="mt-3 lh-base">Increase Trust</h4>
            <p class="fs-0">People trust companies they see other people buy.</p>
          </div>
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/7.png') }}" alt="Dashboard" style="width:95px;" />
            <h4 class="mt-3 lh-base">Social Influence</h4>
            <p class="fs-0">Seeing other visitor taking action creates fear of missing out.</p>
          </div>
        </div>
        <div class="row mb-6">
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/8.png') }}" alt="Dashboard" style="width:95px;" />
          ...
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/9.png') }}" alt="Dashboard" style="width:95px;" />
            <h4 class="mt-3 lh-base">Custom Journeys</h4>
            <p class="fs-0">Take your journey with ease and comfort of different level.</p>
          </div>
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/10.png') }}" alt="Dashboard" style="width:95px;" />
            <h4 class="mt-3 lh-base">Custom Timing</h4>
            <p class="fs-0">Control how fast your notification will display on your screen</p>
          </div>
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/11.png') }}" alt="Dashboard" style="width:95px;" />
            <h4 class="mt-3 lh-base">Live Visitor Count</h4>
            <p class="fs-0">Show how many visitors are browing your site in a time</p>
          </div>
        </div>
        <div class="row mb-6">
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/12.png') }}" alt="Dashboard" style="width:95px;" />
          ...
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/13.png') }}" alt="Dashboard" style="width:95px;" />
            <h4 class="mt-3 lh-base">Custom Rules</h4>
            <p class="fs-0">Granular control over the notification of your activity.</p>
          </div>
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/14.png') }}" alt="Dashboard" style="width:95px;" />
            <h4 class="mt-3 lh-base">Mobile Optimized</h4>
            <p class="fs-0">Optimize the traffic to bring the best to your project.</p>
          </div>
          <div class="col-md-6 col-lg-3 text-center"><img src="{{ asset('assets/img/icons/15.png') }}" alt="Dashboard" style="width:95px;" />
      ...
      <section>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 mb-4"><img class="w-100" src="{{ asset('assets/img/illustration/5.png') }}" alt="..." /></div>
            <div class="col-md-6 text-center text-md-start">
      ...
      <section class="p-0" id="docs">
        <div class="bg-holder d-none d-lg-block" style="background-image:url(assets/img/illustration/6.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row py-7">
            <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img src="assets/img/icons/Logo2.png" height="51" alt="" /></a>
              ...
              <div class="d-flex"><a href="#!"><img class="me-xl-3 me-1" src="{{ asset('assets/img/gallery/linkedin-line1.svg') }}" alt="in" width:'20px'="width:'20px'" height:'20px'="height:'20px'" /></a><a href="#!"><img class="me-xl-3 me-1" src="{{ asset('assets/img/gallery/facebook-line1.svg') }}" alt="fb" width:'20px'="width:'20px'" height:'20px'="height:'20px'" /></a><a href="#!"><img class="me-xl-3 me-1" src="{{ asset('assets/img/gallery/twitter-line1.svg') }}" alt="twitter" width:'20px'="width:'20px'" height:'20px'="height:'20px'" /></a><a href="#!"><img class="me-xl-3 me-1" src="{{ asset('assets/img/gallery/instagram-line1.svg') }}" alt="instragram" width:'20px'="width:'20px'" height:'20px'="height:'20px'" /></a>
              </div>
            </div>
